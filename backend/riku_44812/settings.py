"""
Django settings for riku_44812 project.
...
WSGI_APPLICATION = 'riku_44812.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "riku_44812 API",
    "DESCRIPTION": "API documentation for riku_44812 App",
    "VERSION": "v1",
}
